...
# Usage: build-context.sh <specpaper_dir> <change_name> <task_id>
#
...
Examples:
  build-context.sh .specpaper my-feature T3
  build-context.sh /project/.specpaper auth-system T1
EOF
  exit 0
}
...
if [[ $# -lt 3 ]]; then
  echo "ERROR: Expected 3 arguments: <specpaper_dir> <change_name> <task_id>" >&2
...
# Project root is parent of .specpaper
